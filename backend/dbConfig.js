...
const postTable = "CREATE TABLE `posts` (`id` int NOT NULL AUTO_INCREMENT, `users_id` int NOT NULL, `post_date` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP, `modification_date` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP, `content` text COLLATE utf8_bin NOT NULL, `image_url` varchar(100) COLLATE utf8_bin DEFAULT NULL, PRIMARY KEY (`id`, `users_id`), KEY `fk_posts_users1_idx` (`users_id`), CONSTRAINT `fk_posts_users1` FOREIGN KEY (`users_id`) REFERENCES `users` (`id`) ON DELETE CASCADE ON UPDATE RESTRICT) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8 COLLATE=utf8_bin;";
//Création de la table comments
const commentsTable = "CREATE TABLE `comments` ( `comments_id` int NOT NULL AUTO_INCREMENT, `posts_id` int NOT NULL, `comment_date` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP, `modification_date` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP, `content` varchar(255) COLLATE utf8_bin DEFAULT NULL, PRIMARY KEY (`comments_id`,`posts_id`), KEY `fk_comments_posts1_idx` (`posts_id`), CONSTRAINT `fk_comments_posts1` FOREIGN KEY (`posts_id`) REFERENCES `posts` (`id`) ON DELETE CASCADE) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8 COLLATE=utf8_bin;";
