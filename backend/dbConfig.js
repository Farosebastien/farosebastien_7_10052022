...
const userTable = "CREATE TABLE `users` (`id` int NOT NULL AUTO_INCREMENT, `firstname` varchar(100) COLLATE utf8_bin NOT NULL, `lastname` varchar(100) COLLATE utf8_bin NOT NULL, `username` varchar(100) COLLATE utf8_bin NOT NULL, `email` varchar(100) COLLATE utf8_bin NOT NULL, `role` varchar(100) COLLATE utf8_bin DEFAULT NULL, `password` varchar(255) COLLATE utf8_bin NOT NULL, `photo_url` varchar(255) COLLATE utf8_bin DEFAULT NULL, PRIMARY KEY(`id`), UNIQUE KEY `email_UNIQUE` (`email`), UNIQUE KEY `username UNIQUE` (`username`)) ENGINE=Innodb AUTO_INCREMENT=1 DEFAULT CHARSET=utf8 COLLATE=utf8_bin;";
